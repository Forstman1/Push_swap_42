...
CBONUS = checker1/parsing_bonus.c checker1/sa_pa_ra_rra_bonus.c checker1/sb_pb_rb_rrb_bonus.c checker_utils.c checker1/moves_utils.c checker1/ss_rr_rrr_bonus.c
...
bonus: $(OBONUS) checker1/checker.h checker_bonus.c
	@make -C libft
	@$(CC) $(FLAGS) checker_bonus.c $(OBONUS) libft/libft.a -o $(BONUS_NAME)

execute: all push_swap.c
